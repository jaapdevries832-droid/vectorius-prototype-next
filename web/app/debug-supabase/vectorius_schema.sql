...
\restrict 8YOEWnN5e4L14xCyKtxnhYuHyh0FdgwsptqVlitVduyVZXiIan5Fb9vlGMtDWeM
...
--
-- Name: delete_profile(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete_profile() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: sync_profiles(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sync_profiles() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
begin
...
--
-- Name: mentor_students; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.profiles (
    ...
    email text,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT profiles_role_check CHECK ((role = ANY (ARRAY['mentor'::text, 'student'::text, 'parent'::text])))
);


--
-- Name: student_mentor_assignments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: mentor_students mentor_students_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mentor_students
    ADD CONSTRAINT mentor_students_pkey PRIMARY KEY (mentor_id, student_id);
...
--
-- Name: student_mentor_assignments student_mentor_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_mentor_assignments
    ADD CONSTRAINT student_mentor_assignments_pkey PRIMARY KEY (id);
...
--
-- Name: users on_auth_user_change; Type: TRIGGER; Schema: auth; Owner: -
--
...
--
-- Name: users on_auth_user_delete; Type: TRIGGER; Schema: auth; Owner: -
--
...
--
-- Name: comments comments_assignment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.comments
    ADD CONSTRAINT comments_assignment_id_fkey FOREIGN KEY (assignment_id) REFERENCES public.assignments(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.comments
    ADD CONSTRAINT comments_author_profile_id_fkey FOREIGN KEY (author_profile_id) REFERENCES public.profiles(id) ON DELETE CASCADE;


--
-- Name: mentor_students mentor_students_mentor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mentor_students
    ADD CONSTRAINT mentor_students_mentor_id_fkey FOREIGN KEY (mentor_id) REFERENCES public.mentors(id) ON DELETE CASCADE;


--
-- Name: mentor_students mentor_students_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mentor_students
    ADD CONSTRAINT mentor_students_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id) ON DELETE CASCADE;
...
--
-- Name: student_mentor_assignments student_mentor_assignments_mentor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_mentor_assignments
    ADD CONSTRAINT student_mentor_assignments_mentor_id_fkey FOREIGN KEY (mentor_id) REFERENCES public.profiles(id) ON DELETE CASCADE;


--
-- Name: student_mentor_assignments student_mentor_assignments_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_mentor_assignments
    ADD CONSTRAINT student_mentor_assignments_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
--
-- Name: assignments dev open delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "dev open delete" ON public.assignments FOR DELETE TO anon USING (true);


--
-- Name: assignments dev open insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "dev open insert" ON public.assignments FOR INSERT TO anon WITH CHECK (true);


--
-- Name: assignments dev open read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "dev open read" ON public.assignments FOR SELECT TO anon USING (true);


--
-- Name: assignments dev open update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "dev open update" ON public.assignments FOR UPDATE TO anon USING (true) WITH CHECK (true);


--
-- Name: student_mentor_assignments mentor_assignments_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY mentor_assignments_insert ON public.student_mentor_assignments FOR INSERT WITH CHECK ((mentor_id = auth.uid()));


--
-- Name: student_mentor_assignments mentor_assignments_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY mentor_assignments_read ON public.student_mentor_assignments FOR SELECT USING ((mentor_id = auth.uid()));


--
-- Name: mentor_students; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: mentors mentors_self_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY mentors_self_read ON public.mentors FOR SELECT USING ((profile_id = public.auth_uid()));


--
-- Name: mentors mentors_self_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY mentors_self_write ON public.mentors USING ((profile_id = public.auth_uid())) WITH CHECK ((profile_id = public.auth_uid()));
...
CREATE POLICY profiles_insert_self ON public.profiles FOR INSERT WITH CHECK ((id = public.auth_uid()));


--
-- Name: profiles profiles_insert_self_student; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY profiles_insert_self_student ON public.profiles FOR INSERT WITH CHECK (((id = auth.uid()) AND (role = 'student'::text)));
...
CREATE POLICY profiles_read_own ON public.profiles FOR SELECT USING ((id = public.auth_uid()));
...
CREATE POLICY profiles_update_own ON public.profiles FOR UPDATE USING ((id = public.auth_uid()));


--
-- Name: profiles profiles_update_self_student; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY profiles_update_self_student ON public.profiles FOR UPDATE USING (((id = auth.uid()) AND (role = 'student'::text)));


--
-- Name: student_mentor_assignments student_assignments_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY student_assignments_insert ON public.student_mentor_assignments FOR INSERT WITH CHECK ((student_id = auth.uid()));


--
-- Name: student_mentor_assignments student_assignments_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY student_assignments_read ON public.student_mentor_assignments FOR SELECT USING ((student_id = auth.uid()));


--
-- Name: student_mentor_assignments; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: students students_self_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY students_self_read ON public.students FOR SELECT USING ((profile_id = public.auth_uid()));
...
--
-- Name: FUNCTION auth_uid(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION delete_profile(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION sync_profiles(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE mentor_students; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.mentor_students TO anon;
GRANT ALL ON TABLE public.mentor_students TO authenticated;
GRANT ALL ON TABLE public.mentor_students TO service_role;
...
--
-- Name: TABLE student_mentor_assignments; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.student_mentor_assignments TO anon;
GRANT ALL ON TABLE public.student_mentor_assignments TO authenticated;
GRANT ALL ON TABLE public.student_mentor_assignments TO service_role;
...
\unrestrict 8YOEWnN5e4L14xCyKtxnhYuHyh0FdgwsptqVlitVduyVZXiIan5Fb9vlGMtDWeM
